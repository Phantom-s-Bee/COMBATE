...
void handleRootBTN() {
  String html = "<html>\
                 ...
                 <body>\
                   ...
                   <tr><th>-</th><th><button id='tras' class='button motor-btn' ontouchstart=\"moveCar('tras')\" ontouchend=\"stopCar('tras')\" onmousedown=\"moveCar('tras')\" onmouseup=\"stopCar('tras')\">Tras</button></td><td>-</td></tr>\
                   </table>\
                   </div>\
                   <br>\
                   <button id='ledBtn' class='button device-btn' onclick=\"toggleLed()\">LED</button>\
