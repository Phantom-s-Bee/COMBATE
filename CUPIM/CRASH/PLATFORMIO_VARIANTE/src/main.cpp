...
const IPAddress local_ip(172, 217, 28, 1);
const IPAddress gateway(172, 217, 28, 1);
...
const int pinMotorEsquerdaFrente = 5;   // D1 = GPIO5
const int pinMotorEsquerdaTras = 4;   // D2 = GPIO4
const int pinMotorDireitaFrente = 14;  // D5 = GPIO14
const int pinMotorDireitaTras = 12;  // D6 = GPIO12
...
void handleToggleLed() {
  ledState = !ledState;
  digitalWrite(pinLed, ledState ? LOW : HIGH);
...
void handleToggleRelay() {
  ...
  digitalWrite(pinRelay, relayState ? HIGH : LOW);
